...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @Fantasy_Badshah_IPL_Team __**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 Channel", url="https://t.me/Fantasy_Badshah_IPL_Team"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/Fantasy_Badshah_IPL_Team")
                    ],[
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="http://t.me/Badshah_Req_Bot?startgroup")
                    ]
                ]
            )
